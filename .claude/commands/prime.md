# /prime — orient in the SNH project

Prime yourself on the Social Network Health project before starting work. Do the following, then
report back:
...
5. If there is a `presentations/` folder with an active talk, glance at its README/notes.

Then give a one-paragraph orientation summary: what this repo is, which related repos are available
locally, and anything in-flight (active presentation, recent research notes) relevant to the
session. Keep it short — this is orientation, not a report.
